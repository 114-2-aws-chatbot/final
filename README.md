...
8. 在 OAuth2 勾選完畢後，底下會有一段 URL，把它複製到瀏覽器中。
<img width="1918" height="866" alt="image" src="https://github.com/user-attachments/assets/f32b54c9-97fa-4941-801b-ff1a973cb62c" />

9. 複製到瀏覽器會有這個畫面，點「新增至我的應用程式」![image](https://hackmd.io/_uploads/SkW9QPoyMg.png)

但裝是裝進去了，現在還不能跟你聊天。

額外測試：
終端機輸入指令python bot.py，看到目前登入身分：你的Bot名稱#1234就代表成功囉。
